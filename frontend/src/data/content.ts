...
export interface WhyChooseCapability {
    name: string;
    icon: LucideIcon;
}
...
export const CYBER_CAPABILITIES: Capability[] = [
...
export const WHY_CHOOSE_CAPABILITIES: WhyChooseCapability[] = [
...
export const BLOG_CATEGORIES: string[] = ["All", "Cybersecurity", "Cloud", "AI", "IT", "Digital Transformation", "Technology"];

const demoBody = (topic: string): string[] => [
...
export const INDUSTRY_OPTIONS: string[] = INDUSTRIES.map((i) => i.name);
export const INTEREST_OPTIONS: string[] = [...SOLUTIONS.map((s) => s.title), "General Inquiry"];
